...
const AppShell: React.FC = () => {
  ...
  // Close sidebar on ANY route change (not just workspaceId) — mobile UX
      ...
      <div style={{ display: 'flex', height: '100vh', width: '100vw', overflow: 'hidden', background: 'var(--bg-page)' }}>
        ...
        >
          ...
          <nav
            ...
            style={{ flex: 1, overflowY: 'auto', overflowX: 'hidden', minHeight: 0, padding: '1rem 0.75rem', display: 'flex', flexDirection: 'column', gap: '2px' }}
        ...
        >
          <div
            ...
            style={{ flex: 1, padding: '2rem 2.5rem', maxWidth: '1280px', width: '100%', margin: '0 auto', animationName: 'fade-in', animationDuration: '0.2s', animationFillMode: 'forwards' }}
          >
            <Outlet />
          </div>
        </main>
